...
class Post extends Model
{
    ...
    // protected $fillable = ['tittle', 'author', 'excerpt', 'body']; //yang boleh dirubah ['tittle', 'author', 'excerpt', 'body']
    protected $guarded = ['id']; //gaboleh dirubah id-nya
    protected $with = ['category', 'author'];

    public function scopeFilter($query, array $filters)
    {
        //  if(isset($filters['search']) ? $filters['search'] : false){
        //    return $query->where('tittle', 'like', '%' . $filters['search']. '%') //mencari pada bagian juudul
