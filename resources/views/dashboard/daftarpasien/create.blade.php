...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Daftar Pasien Baru</h1>
</div>
    ...
    <form action="/dashboard/daftarpasien" method="post" class="mb-5">
      ...
      <div class="form-floating mb-2">
             ...
             <div class="form-floating mb-2" id="bpjsField">
              <input type="number" name="bpjs" class="form-control @error('bpjs') is-invalid @enderror" id="bpjs" placeholder="Nomer BPJS" value="{{ old('bpjs') }}">
            ...
            <div class="form-floating mb-2">
             ...
             <div class="form-floating mb-2">
              <input type="password" name="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" id="confirm_password" placeholder="Password">
            ...
            <br> 
            <button type="submit" class="mt-2 btn btn-primary btn-dark"><span data-feather="user"></span> Register</button>
