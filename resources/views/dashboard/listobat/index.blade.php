    ...
    <form action="/dashboard/listobat" method="GET">
      @csrf
        <div class="input-group mb-3">
            <input type="text" name="search" class="form-control" value="{{ request('search') }}" placeholder="Cari nama obat...">
...
<table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="col-md-3">
           <input type="number" hidden class="form-control form-control-sm input-qty"  max="{{ $obat->stok }}" min="1" value="1">
           </div>
            <button type="button" class="badge btn-add-to-cart" id="btn-add-to-cart"
              obat-kode="{{ $obat->kode_obat }}" obat-nama="{{ $obat->nama_obat }}" obat-harga="{{ $obat->harga }}" obat-stok="{{ $obat->stok }}">
