...
<a class="btn btn-primary mb-3" href="/dashboard/tambahobat/create"><span data-feather="plus" class="align-text-bottom"></span> Tambah Obat</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/dashboard/tambahobat/{{$obat->kode_obat}}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
