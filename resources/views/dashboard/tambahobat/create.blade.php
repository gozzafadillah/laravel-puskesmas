...
<form action="/dashboard/tambahobat" method="post" class="mb-3">
    ...
    <input type="text"  class="form-control @error('kode_obat') is-invalid @enderror" id="kode_obat" name="kode_obat" placeholder="Masukan Kode Obat" value="{{ old('kode_obat') }}" autofocus>
    @error('kode_obat')
    ...
    <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" placeholder="Masukan Stok Obat" value="{{ old('stok') }}">
    @error('stok')
            <div class="invalid-feedback">
            {{ $message }}
        </div>
    ...
    <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" placeholder="Masukan Harga Obat" value="{{ old('harga') }}">
    @error('harga')
            <div class="invalid-feedback">
            {{ $message }}
        </div>
