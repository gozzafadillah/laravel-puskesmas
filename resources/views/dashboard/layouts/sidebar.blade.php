...
@elseif(auth()->user()->is_admin == 2)
    ...
    @elseif(auth()->user()->is_admin == 3)
     @can('administrasi')
      <p class="fs-4 sidebar-heading d-flex justify-content-between align-items-center px-3 mb-1">Administrasi Keuangan</p>
 ...
 @elseif(auth()->user()->is_admin == 4)
  ...
  @else
          ...
          <ul class="nav flex-column">
           ...
           <li class="nav-item">
            <a class="nav-link {{ Request::is('#*') ? 'active' : ''}}{{ auth()->user()->cek == 0 || auth()->user()->cek == 2 ? ' disabled' : ''}}" href="#"
              @if(auth()->user()->cek == 0 || auth()->user()->cek == 2)
                  style="color: gray"
              @endif>
              <span data-feather="grid" class="align-text-bottom"></span>
