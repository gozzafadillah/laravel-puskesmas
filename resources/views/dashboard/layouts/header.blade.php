    ...
    <div class="dropdown ms-auto">
      <button class="btn btn-secondary dropdown-toggle bg-dark" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span data-feather="menu"></span>
        ...
        <ul class="dropdown-menu dropdown-menu-dark bg-dark">
          <li>
            <a href="/dashboard/profile/{profile}/edit" class="text-decoration-none text-light"><span data-feather="user"></span> 
              Profile 
            </a>
          </li>
        ...
        <li><hr class="dropdown-divider"></li>
          <li>
            <a href="/posts" class="text-decoration-none text-light"><span data-feather="hexagon"></span> 
              Website
            </a>
          </li>
      </ul>
