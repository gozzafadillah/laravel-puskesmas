        ...
        <form action="/dashboard/profile/{{ auth()->user()->id }}" method="post" class="mb-5">
            ...
            <div class="col-lg-8 mb-3">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="date" name="tgllahir" class="form-control" id="tgllahir" placeholder="Tanggal Lahir"
                        required value="{{ old('tgllahir', auth()->user()->tgllahir) }}">
                    @error('tgllahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                        id="alamat" placeholder="0000000" required value="{{ old('alamat', auth()->user()->alamat) }}">
                    @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="kepalakeluarga" name="kepalakeluarga"
                        ...
                        placeholder="0000000" required value="{{ old('kepalakeluarga', auth()->user()->kepalakeluarga) }}">
                ...
                <div class="mt-3 mb-3">
                    ...
                    @else
                        <input type="text" name="bpjs" class="form-control @error('bpjs') is-invalid @enderror"
                            id="bpjs" required value="{{ old('bpjs', auth()->user()->bpjs) }}">
                        @error('bpjs')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="password" class="form-control @error('old_password') is-invalid @enderror"
                        id="old_password" placeholder="Masukan Password lama" name="old_password">
                    @error('old_password"')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
