...
<div class="col-lg-8">
  <form action="/dashboard/tambahacategoryobat/edit/{{$category->id}}" method="post" class="mb-5" enctype="multipart/form-data">
      @method('put')
      @csrf
    <div class="mb-3">
      <label for="name" class="form-label">Nama Category</label>
      <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('slug', $category->name) }}" autofocus>
      @error('name')
