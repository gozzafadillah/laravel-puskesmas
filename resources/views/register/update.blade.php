...
<div class="row justify-content-center">
    <div class="col-lg-5">
      <img src="{{ asset('img/Lambang_Kabupaten_Subang.png') }}" style="display: block; margin: auto; width: 200px; height: auto;">
        <main class="form-registration">         
            <h1 class="h3 mb-3 fw-normal text-center">Pengguna Baru Aja</h1>
          ...
          <form action="/register" method="post">
            ...
            <div class="form-floating mb-2">
              <input type="number" name="NIK" class="form-control @error('NIK') is-invalid @enderror" id="NIK" placeholder="Nama Lengkap" value="{{ old('NIK') }}" required autofocus>
            ...
            <div class="form-floating mb-2">
            <input type="date" name="tgllahir" class="form-control" id="tgllahir" placeholder=" " required value="{{ old('tgllahir') }}">
            ...
            @enderror
             ...
             <div class="form-floating mb-2">
              <input type="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="0000000" required value="{{ old('alamat') }}">
             ...
             <div class="form-floating mb-2">
              <input type="kepalakeluarga" name="kepalakeluarga" class="form-control @error('kepalakeluarga') is-invalid @enderror" id="kepalakeluarga" placeholder="0000000" required value="{{ old('kepalakeluarga') }}">
             ...
             <div class="form-floating mb-2" id="bpjsField">
              <input type="number" name="bpjs" class="form-control @error('bpjs') is-invalid @enderror" id="bpjs" placeholder="" value="{{ old('bpjs') }}">
            ...
            <div class="form-floating mb-2">
             ...
             <div class="form-floating mb-2">
              <input type="password" name="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" id="confirm_password" placeholder="Password" required>
            ...
            <button class="w-100 btn-dark btn-lg btn-primary mt-3" type="submit" ><i class="bi bi-person"></i> Register </button>
          </form>
